...
mkdir /vast/scratch/users/jackson.v/retThickness/filteringGeneticDataNoExclusions/
cd /vast/scratch/users/jackson.v/retThickness/filteringGeneticDataNoExclusions/
...
# project directory
projDir=/vast/scratch/users/jackson.v/retThickness/filteringGeneticDataNoExclusions
...
myQCFilesDir=/wehisan/bioinf/lab_bahlo/projects/misc/retinalThickness/genotypeQCnoExclusions/output/
