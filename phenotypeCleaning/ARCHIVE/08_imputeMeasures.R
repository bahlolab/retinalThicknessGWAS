...
start <- ((chunk - 1) * 10000) + 1
 ...
 pheno <- fread("/wehisan/bioinf/lab_bahlo/projects/misc/retinalThickness/phenotypeCleaning/output/scansRefErrAdjustedWideFormat.csv")
...
fwrite(imputedScans, file = paste0("/wehisan/bioinf/lab_bahlo/projects/misc/retinalThickness/phenotypeCleaning/output/scansRefErrAdjustedImputedWideFormat_chunk",chunk,".csv"), sep = ",")
